...
for dirname, _, filenames in os.walk('D:/Ingenium/brain_tumor_dataset'):
...
for r, d, f in os.walk(r'D:/Ingenium/brain_tumor_dataset/yes'):
    for file in f:
        if '.jpg' in file:
...
paths = []
for r, d, f in os.walk(r"D:/Ingenium/brain_tumor_dataset/no"):
    for file in f:
        if '.jpg' in file:
            paths.append(os.path.join(r, file))
...
tumour_detect('D:/Ingenium/brain_tumor_dataset/yes/Y3.jpg')    
model.save('D:/Ingenium/model.hdf5')